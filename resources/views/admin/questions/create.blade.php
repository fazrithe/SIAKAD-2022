...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.questions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="question_answare">{{ trans('cruds.question.fields.question_answare') }}</label>
                <div class="row mb-2">
                <div class="col-1">
                    <label>A</label>
                </div>
                <div class="col">
                    <input class="form-control {{ $errors->has('question_answare_a') ? 'is-invalid' : '' }}" type="text" name="question_answare_a" id="question_text" value="{{ old('question_text', '') }}" required>
                    @if($errors->has('question_answare'))
                        <div class="invalid-feedback">
                            {{ $errors->first('question_answare') }}
                        </div>
                    @endif
                    <span class="help-block">{{ trans('cruds.question.fields.question_text_helper') }}</span>
                </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <input class="form-control {{ $errors->has('question_answare_b') ? 'is-invalid' : '' }}" type="text" name="question_answare_b" id="question_text" value="{{ old('question_text', '') }}" required>
                        @if($errors->has('question_answare'))
                            <div class="invalid-feedback">
                                {{ $errors->first('question_answare') }}
                            </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <input class="form-control {{ $errors->has('question_answare_c') ? 'is-invalid' : '' }}" type="text" name="question_answare_c" id="question_text" value="{{ old('question_text', '') }}" required>
                        @if($errors->has('question_answare'))
                            <div class="invalid-feedback">
                                {{ $errors->first('question_answare') }}
                            </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <input class="form-control {{ $errors->has('question_answare_d') ? 'is-invalid' : '' }}" type="text" name="question_answare_d" id="question_text" value="{{ old('question_text', '') }}" required>
                        @if($errors->has('question_answare'))
                            <div class="invalid-feedback">
                                {{ $errors->first('question_answare') }}
                            </div>
