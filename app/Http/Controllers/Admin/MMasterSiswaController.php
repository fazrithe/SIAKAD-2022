...
class MMasterSiswaController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.mMasterSiswas.create', compact('angkatans', 'jurusans', 'kelas', 'kelamins', 'statuses','roles'));
    }
    ...
    public function store(StoreMMasterSiswaRequest $request)
    {
        ...
        $mUser = new User();
        $mUser->code = $request->post('nisn');
        $mUser->name = $request->post('nama');
        $mUser->email = $request->post('email');
        $mUser->password = $request->post('password');
        $mUser->save();

        $mUser->roles()->sync($request->input('roles', []));
    ...
    public function destroy(MMasterSiswa $mMasterSiswa)
    {
        ...
        User::where('code', '=', $mMasterSiswa->nisn)->delete();
